...
set key outside 
# 
set title 'Blocked KIJ Comparison : Matrix size v Time taken' 
...
set origin 0,0 
set key outside 
plot 'logDir/Bkij.dat' u 1:3 t 'manual simple' w l lw 0.8 lc rgb 'blue', 'logDir/Bkij.dat' u 1:4 t 'manual complex' w l lw 0.8 lc rgb 'black', 'logDir/Bkij.dat' u 1:5 t 'dgemm' w l lw 0.8 lc rgb 'red' 
# 
pause -1
